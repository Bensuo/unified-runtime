...
TEST_P(KernelCommandEventSyncTest, Basic) {
    ...
    ASSERT_SUCCESS(urCommandBufferAppendKernelLaunchExp(
        cmd_buf_handle, kernel, 1, &global_offset, &elements, nullptr, 1,
        &sync_points[0], 1, &external_events[0], &sync_points[1],
...
TEST_P(KernelCommandEventSyncTest, InterCommandBuffer) {
    ...
    ASSERT_SUCCESS(urCommandBufferAppendUSMMemcpyExp(
        cmd_buf_handle, device_ptrs[0], dataX.data(), allocation_size, 0,
        nullptr, 0, nullptr, &sync_points[0], nullptr, nullptr));
    ...
    ASSERT_SUCCESS(urCommandBufferAppendKernelLaunchExp(
        ...
        nullptr, 1, &external_events[0], &sync_points[1], nullptr, nullptr));
...
TEST_P(KernelCommandEventSyncUpdateTest, TwoWaitEvents) {
    ...
    ASSERT_SUCCESS(urCommandBufferAppendKernelLaunchExp(
        updatable_cmd_buf_handle, kernel, 1, &global_offset, &elements, nullptr,
        0, nullptr, 2, &external_events[0], &sync_points[0],
...
TEST_P(KernelCommandEventSyncUpdateTest, InvalidWaitUpdate) {
    ...
    ASSERT_SUCCESS(urCommandBufferAppendKernelLaunchExp(
        updatable_cmd_buf_handle, kernel, 1, &global_offset, &elements, nullptr,
        0, nullptr, 1, &external_events[0], nullptr, nullptr, &command_handle));
...
TEST_P(KernelCommandEventSyncUpdateTest, InvalidSignalUpdate) {
    ASSERT_SUCCESS(urCommandBufferAppendKernelLaunchExp(
        updatable_cmd_buf_handle, kernel, 1, &global_offset, &elements, nullptr,
        0, nullptr, 0, nullptr, nullptr, nullptr, &command_handle));
