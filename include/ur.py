...
class ur_function_v(IntEnum):
    ...
    COMMAND_BUFFER_APPEND_USM_MEMCPY_EXP = 182      ## Enumerator for ::urCommandBufferAppendUSMMemcpyExp
    COMMAND_BUFFER_APPEND_USM_FILL_EXP = 183        ## Enumerator for ::urCommandBufferAppendUSMFillExp
    COMMAND_BUFFER_APPEND_MEM_BUFFER_COPY_EXP = 184 ## Enumerator for ::urCommandBufferAppendMemBufferCopyExp
    COMMAND_BUFFER_APPEND_MEM_BUFFER_WRITE_EXP = 185## Enumerator for ::urCommandBufferAppendMemBufferWriteExp
    COMMAND_BUFFER_APPEND_MEM_BUFFER_READ_EXP = 186 ## Enumerator for ::urCommandBufferAppendMemBufferReadExp
    COMMAND_BUFFER_APPEND_MEM_BUFFER_COPY_RECT_EXP = 187## Enumerator for ::urCommandBufferAppendMemBufferCopyRectExp
