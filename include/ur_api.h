...
typedef enum ur_function_t {
    ...
    UR_FUNCTION_COMMAND_BUFFER_APPEND_USM_MEMCPY_EXP = 182,                    ///< Enumerator for ::urCommandBufferAppendUSMMemcpyExp
    UR_FUNCTION_COMMAND_BUFFER_APPEND_USM_FILL_EXP = 183,                      ///< Enumerator for ::urCommandBufferAppendUSMFillExp
    UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_COPY_EXP = 184,               ///< Enumerator for ::urCommandBufferAppendMemBufferCopyExp
    UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_WRITE_EXP = 185,              ///< Enumerator for ::urCommandBufferAppendMemBufferWriteExp
    UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_READ_EXP = 186,               ///< Enumerator for ::urCommandBufferAppendMemBufferReadExp
    UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_COPY_RECT_EXP = 187,          ///< Enumerator for ::urCommandBufferAppendMemBufferCopyRectExp
    UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_WRITE_RECT_EXP = 188,         ///< Enumerator for ::urCommandBufferAppendMemBufferWriteRectExp
    UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_READ_RECT_EXP = 189,          ///< Enumerator for ::urCommandBufferAppendMemBufferReadRectExp
    UR_FUNCTION_COMMAND_BUFFER_APPEND_MEM_BUFFER_FILL_EXP = 190,               ///< Enumerator for ::urCommandBufferAppendMemBufferFillExp
